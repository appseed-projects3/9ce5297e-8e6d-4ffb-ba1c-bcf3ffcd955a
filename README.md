...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-23 20:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9ce5297e-8e6d-4ffb-ba1c-bcf3ffcd955a.git
$ cd 9ce5297e-8e6d-4ffb-ba1c-bcf3ffcd955a
```
